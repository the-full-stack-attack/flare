...
const butterFlareEffect: FlareArr = [
  'Butterflare Effect',
  'Special Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'butterFlare.png'),
...
const goGetter: FlareArr = [
  'Go Getter',
  'Task Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'goGetter.png'),
...
const theHost: FlareArr = [
  'The Host',
  'Event Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'theHost.png'),
...
const storedThoughts: FlareArr = [
  'Stored Thoughts(x3)',
  'AI Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'storedThoughts.png'),
...
const theSpark: FlareArr = [
  'The Spark',
  'Event Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'theSpark.png'),
...
const multiTasker: FlareArr = [
  'Multitasker',
  'Task Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'multitasker.png'),
...
const socialDynamo: FlareArr = [
  'Social Dynamo',
  'Event Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'socialDynamo.png'),
...
const venueVirtuoso: FlareArr = [
  'Venue Virtuoso',
  'Venue Flare',
  path.join(__dirname, '..', 'seeds', 'flareImages', 'venueVirtuoso.png'),
